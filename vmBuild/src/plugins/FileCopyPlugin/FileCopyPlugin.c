 ...
 */
static char __buildInfo[] = "FileCopyPlugin VMMaker-oscog-jeanbaptistearnaud.314 uuid: 9a82bb5d-38d0-4216-a6e9-88a33cf5eeab " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"FileCopyPlugin VMMaker-oscog-jeanbaptistearnaud.314 (i)"
#else
	"FileCopyPlugin VMMaker-oscog-jeanbaptistearnaud.314 (e)"
#endif
;
